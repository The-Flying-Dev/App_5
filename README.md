...
A Maths based console game which includes the 4 standard arithmetic operations; "Addition, Subtraction, Division and Multiplication". The following topics are covered: `Arrays`, `Lists`, `Switch Statements`, `Object Oriented Programming`, `Models`, `Enumerations`, `Linq`, `Validation` and `Debugging`.
